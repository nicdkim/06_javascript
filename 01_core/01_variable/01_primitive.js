...
/*
    ...
    undefined 는 자바스크립트 엔진이 변수를 초기화 할 대 사용하는 값이고,
    개발자가 의도적으로 할당하는 것은 본래 취지와 어긋나고 혼란을 줄 수 있다.
    그렇기 때문에 의도적인 빈 값은 null을 주는 것이 바람직하다.
*/
let test;
console.log(test);

// const test2; const는 상수 이기 때문에 undefined 로 초기화 할 수 없다.
