...
console.log(`foodList.lasIndexOf("물회",1) : ${foodList.lastIndexOf("물회",1)}`);
...
// splice : 배열의 index 위치 제거 후 추가

const front = ["html","css","javascript","jQuery"];

// slice(시작인텍스,종료인덱스)
console.log(`front.splice(1,3) : ${front.splice(1,3)}`);
console.log(front);
...
console.log(`snackList.join() : ${snackList}`);     // .toString 생량
